...
class Client extends types_1.IClient {
    constructor(opts) {
        super(opts);
        this.protocol = constants_1.CLIENT_PROTOCOL;
        this.version = constants_1.CLIENT_VERSION;
        this.name = constants_1.CLIENT_DEFAULT.name;
        ...
        this.name = (opts === null || opts === void 0 ? void 0 : opts.name) || constants_1.CLIENT_DEFAULT.name;
        ...
        const logger = typeof (opts === null || opts === void 0 ? void 0 : opts.logger) !== "undefined" && typeof (opts === null || opts === void 0 ? void 0 : opts.logger) !== "string"
            ? opts.logger
            : pino_1.default(logger_1.getDefaultLoggerOptions({ level: (opts === null || opts === void 0 ? void 0 : opts.logger) || constants_1.CLIENT_DEFAULT.logger }));
