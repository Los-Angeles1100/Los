...
class Engine extends types_1.IEngine {
    constructor(client) {
        ...
        this.connect = (params) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.client.proposal.set(id, Object.assign({ id }, proposal));
            return { uri, approval };
        });
        ...
        this.find = params => {
            this.isInitialized();
            return this.client.session.values.filter(session => utils_1.isSessionCompatible(session, params));
        };
